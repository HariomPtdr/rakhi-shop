/* ── PRODUCTS ──────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────── */
const PRODUCTS = [
  { id:"nazar", name:"Nazar Evil Eye Rakhi", price:59, mrp:98, cat:"evil-eye", tags:["evil-eye","designer","protection"], feat:1,
  ...
  { id:"pearl", name:"Pearl Bead Rakhi", price:49, mrp:82, cat:"pearl", tags:["pearl","designer","classic"], feat:2, img:null,
  ...
  { id:"om", name:"Om Kalava Rakhi", price:39, mrp:65, cat:"traditional", tags:["religious","traditional","kalava"], feat:3, img:null,
    desc:"Plain red and yellow kalava with a gold-tone Om. The simplest thing we make.",
    art:{thread:"#D4A017", bead:"#C0272D", charm:"om"} },
  { id:"rudra", name:"Rudraksh Rakhi", price:79, mrp:132, cat:"traditional", tags:["religious","rudraksh","for-bhaiya"], feat:4, img:null,
  ...
  { id:"kids", name:"Kids Bright Rakhi", price:49, mrp:82, cat:"kids", tags:["kids","cartoon","bright"], feat:5, img:null,
  ...
  { id:"lumba", name:"Bhabhi Lumba Rakhi", price:99, mrp:165, cat:"lumba", tags:["bhabhi","lumba","designer"], feat:6, img:null,
  ...
  { id:"swastik", name:"Swastik Thread Rakhi", price:45, mrp:75, cat:"traditional", tags:["religious","traditional","swastik"], feat:7, img:null,
  ...
  { id:"heart", name:"Heart Charm Rakhi", price:55, mrp:92, cat:"kids", tags:["kids","charm","friendship"], feat:8, img:null,
    desc:"Red heart on pink thread with gold beads. Doubles as a friendship band.",
    art:{thread:"#E0507F", bead:"#E5B84B", charm:"dil"} },
  { id:"set2", name:"Bhaiya–Bhabhi Set", price:149, mrp:248, cat:"lumba", tags:["bhaiya-bhabhi","set","lumba"], feat:9, img:null,
    desc:"One rakhi for bhaiya, one matching lumba for bhabhi, in the same colour family.",
    art:{thread:"#C0272D", bead:"#FFD447", charm:"dil"} },
  { id:"silver", name:"Silver-Look Flower Rakhi", price:199, mrp:332, cat:"premium", tags:["designer","premium","gift-box"], feat:10, img:null,
    desc:"Silver-plated flower on maroon velvet thread. Arrives in a small gift box.",
    art:{thread:"#7A1F3D", bead:"#E6E8EA", charm:"ful"} },
  { id:"kundan", name:"Gold Kundan Rakhi", price:249, mrp:415, cat:"premium", tags:["designer","premium","kundan","gift-box"], feat:11, img:null,
  ...
  { id:"zardosi", name:"Royal Zardosi Rakhi", price:349, mrp:582, cat:"premium", tags:["designer","premium","zardosi","gift-box"], feat:12, img:null,
