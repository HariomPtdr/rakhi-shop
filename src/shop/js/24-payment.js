...
function showOrderDone(b){
  ...
  $("#bill").innerHTML = `
    <div class="bill-done">
      ...
      <p>${esc(billNo)} · ${inr(billTotal())} to pay when it arrives.<br>
         We will confirm it on WhatsApp shortly. You can follow it in
         <a href="#account" id="doneAcct">your orders</a>.</p>
      <div class="done-acts">
